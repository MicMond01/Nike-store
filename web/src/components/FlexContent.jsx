...
const FlexContent = ({
  ifExists,
  endpoint: { heading, title, text, img, btn, url },
}) => {
  return (
    <div
    ...
    >
      <div className="max-w-lg lg:max-w-none w-full md:text-center grid items-center lg:justify-items-center">
        <h1 className="text-4x1 sm:text-3xl font-bold text-gradient">
          {heading}
        </h1>
        <h1 className="text-5x1 lg:text-4xl md:text-3xl sm:text-2xl font-bold text-slate-900 filter drop-shadow-lg">
          {title}
        </h1>
